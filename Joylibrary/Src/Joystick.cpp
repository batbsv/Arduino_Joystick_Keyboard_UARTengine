...
#define JOYSTICK_INCLUDE_Slider1 B01000000
#define JOYSTICK_INCLUDE_Slider2 B10000000
	...
	bool includeslider2	)
{
	...
	_includeAxisFlags |= (includeslider1 ? JOYSTICK_INCLUDE_Slider1 : 0);	
	_includeAxisFlags |= (includeslider2 ? JOYSTICK_INCLUDE_Slider2 : 0);
	...
	} // X, Y, Z, Rx, Ry, and Rz Axis	+Sliders
...
void Joystick_::setSlider1(int16_t value)
{
	_slider1 = value;
	if (_autoSendState) sendState();
}
void Joystick_::setSlider2(int16_t value)
{
	_slider2 = value;
	if (_autoSendState) sendState();
}
...
void Joystick_::sendState()
{
	...
	index += buildAndSetAxisValue(_includeAxisFlags & JOYSTICK_INCLUDE_Slider2, _slider2, _slider2min, _slider2max, &(data[index]));
	index += buildAndSetAxisValue(_includeAxisFlags & JOYSTICK_INCLUDE_Slider1, _slider1, _slider1min, _slider1max, &(data[index]));
