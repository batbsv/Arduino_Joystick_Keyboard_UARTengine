...
#define JOYSTICK_DEFAULT_BUTTON_COUNT       128
...
private:
	...
	int16_t                  _slider1max = JOYSTICK_DEFAULT_AXIS_MAXIMUM;
	int16_t                  _slider2max = JOYSTICK_DEFAULT_AXIS_MAXIMUM;
	int16_t			 	 	 _slider1min =JOYSTICK_DEFAULT_AXIS_MINIMUM;
    int16_t					 _slider2min =JOYSTICK_DEFAULT_AXIS_MINIMUM;
...
public:
	Joystick_(
		...
		bool includeslider1 = true,
		bool includeslider2 = true);
	...
	inline void setSlider1Range(int16_t minimum, int16_t maximum)
	{
		_slider1min = minimum;
		_slider1max = maximum;
	}
	inline void setSlider2Range(int16_t minimum, int16_t maximum)
	{
		_slider2min = minimum;
		_slider2max = maximum;
	}
	...
	void setSlider1(int16_t value);
	void setSlider2(int16_t value);
